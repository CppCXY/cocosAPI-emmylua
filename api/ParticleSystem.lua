...
---@param __endSize float
---@return  cc.ParticleSystem
function ParticleSystem:setEndSize (__endSize) end
---------------------------------
---  Gets the gravity.<br>
--- return The gravity.
---@return  vec2_table
...
---@param __endRadius float
---@return  cc.ParticleSystem
function ParticleSystem:setEndRadius (__endRadius) end
---------------------------------
---  Gets the speed.<br>
--- return The speed.
---@return  float
...
---@param __endRadiusVar float
---@return  cc.ParticleSystem
function ParticleSystem:setEndRadiusVar (__endRadiusVar) end
---------------------------------
...
---@param __endSpinVar float
---@return  cc.ParticleSystem
function ParticleSystem:setEndSpinVar (__endSpinVar) end
---------------------------------
...
---@param __endSpin float
---@return  cc.ParticleSystem
function ParticleSystem:setEndSpin (__endSpin) end
---------------------------------
...
---@return  cc.ParticleSystem
function ParticleSystem:setBlendFunc (__blendFunc) end
---------------------------------
