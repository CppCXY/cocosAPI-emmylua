...
---@return  cc.SpriteBatchNode
function SpriteBatchNode:setBlendFunc (__blendFunc) end
---------------------------------
...
---@return  cc.SpriteBatchNode
function SpriteBatchNode:draw (__renderer,transform,flags) end
---------------------------------
--- js NA
---@return  string
...
---@return  cc.SpriteBatchNode
function SpriteBatchNode:visit (__renderer,parentTransform,parentFlags) end
---------------------------------
--- 
---@return  cc.SpriteBatchNode
